...
int main() {
   int num1 = 0, num2 = 1, nextTerm = 0;  //Initialising and declaring 3 variables.
   ...
   do {
      ...
      nextTerm = num1 + num2; //Adding num1 and num2 and storing it in nextTerm.
      num1 = num2;   //The values of num1 and num2 is updated num1 is assigned the value of num2.
      num2 = nextTerm;  //numè is assigned the value of nextTerm.
